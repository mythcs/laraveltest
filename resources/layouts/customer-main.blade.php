        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark elegant-color">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a href="{{ URL::route('customer.dashboard') }}" class="nav-link active">订位纪录</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ URL::route('customer.booking') }}" class="nav-link">订位</a>
                    </li>
                ...
                <ul class="navbar-nav nav-flex-icons">
                    @if (Auth::guard('customer')->check())
                    <li class="nav-item">
                        <a href="{{ URL::route('customer.logout') }}" class="nav-link">{{ Auth::user()->name }} | 登出</a>
                    </li>
                    @endif
